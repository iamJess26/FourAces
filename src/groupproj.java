...
public class groupproj {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					groupproj window = new groupproj();
	...
	private void initialize() {
		...
		frame.addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				//========================================================================
					...
					String sRef = String.format(" " +  refs);
		...
		frame.getContentPane().add(lblMealAllowance);
		...
		frame.getContentPane().add(lblNewLabel_1_5_1_1_1);
		...
		frame.getContentPane().add(txtSSSNumber);
		...
		frame.getContentPane().add(txtSSSContri);
		...
		btnPaySlip.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				rtfPaySlip.append("The Choosen One\n");
		...
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\jomar\\Desktop\\proll.png"));
